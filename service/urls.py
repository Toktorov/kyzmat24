...
urlpatterns = [
    ...
    path('user/reset-password/<token>', TemplateView.as_view(template_name = 'index.html'), name = "reset-password-token"),
    path('user/orders/order-details/<int:id>/', TemplateView.as_view(template_name = 'index.html'), name = "order-details"),
